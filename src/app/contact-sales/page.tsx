  ...
  return (
    <main className="min-h-screen pt-32 px-4 sm:px-8 bg-white flex justify-center pb-20">
      <div className="max-w-2xl w-full">
        <AnimatedText el="h1" text="Contact Sales" className="text-4xl sm:text-5xl font-extrabold mb-4 text-[#0B3D2E] text-center" />
        <p className="text-center text-gray-600 mb-12">Get in touch with our sales team to discuss how SourceTrace can transform your enterprise supply chain.</p>
        ...
        <form className="space-y-6 bg-gray-50 p-8 sm:p-12 rounded-3xl border border-gray-100 shadow-sm">
           ...
           <Button type="submit" className="w-full h-14 text-lg">Submit</Button>
        </form>
      </div>
    </main>
  );
