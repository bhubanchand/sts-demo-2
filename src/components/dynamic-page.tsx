...
export function DynamicPage({ title, category }: DynamicPageProps) {
  ...
  return (
    <main className="min-h-screen pt-32 px-4 sm:px-8 bg-[#F4FAF6] pb-24 select-none">
      <div className="max-w-4xl mx-auto">
        <span className="text-[#1F7A53] font-bold tracking-widest uppercase mb-4 block text-xs">
          {category}
        </span>
        <h1 className="text-4xl sm:text-6xl font-black mb-8 text-[#0B3D2E] capitalize tracking-tight">
          {title}
        </h1>
        
        <div className="bg-white rounded-[32px] p-6 sm:p-12 shadow-[0_12px_40px_rgba(0,77,38,0.02)] border border-[#0B3D2E]/8">
          <div className="prose prose-lg prose-green max-w-none">
            <h2 className="text-2xl font-extrabold text-[#0B3D2E] mb-3">Under Construction</h2>
            <p className="text-[#1F5946] text-sm sm:text-base leading-relaxed mb-8 font-medium max-w-2xl">
              Our developers are working their best to fix this and bring you the best possible experience. In the meantime, try helping our tractor navigate the supply chain hurdles below!
            </p>
            
            {/* ── TRACTOR RUN MINIGAME ── */}
            <div className="bg-[#F4FAF6] p-4 sm:p-6 rounded-2xl border border-[#0B3D2E]/10 relative overflow-hidden">
            ...
            <div className="mt-8 flex justify-center sm:justify-start">
              <Link href="/">
                <Button className="rounded-full bg-[#0B3D2E] hover:bg-[#125c44] text-white font-bold px-6 flex items-center gap-2">
