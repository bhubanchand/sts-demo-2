...
export function TechStackGrid() {
  return (
    <div className="w-full max-w-[1400px] mx-auto py-32 px-4 sm:px-8 snap-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-6 h-auto md:h-[600px]">
         {TECHNOLOGIES.map((tech) => (
            <div 
               key={tech.id}
               className={`${tech.span} relative overflow-hidden bg-white rounded-[40px] border border-gray-100 p-10 group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2`}
            >
               {/* Background Flare */}
               ...
               <div className="relative z-10 h-full flex flex-col">
                  <div className={`w-16 h-16 ${tech.color} rounded-2xl flex items-center justify-center mb-8 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
