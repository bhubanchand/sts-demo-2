...
export function DataGreenEngine() {
  ...
  // Auto-center the desktop horizontal scroll on mount (for legacy behavior if viewport is medium-large)
  useEffect(() => {
    ...
    <div className="relative w-full pt-10 pb-20 px-4 md:px-6 flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-[#f9faf9] to-[#eef5ef] text-gray-900 select-none overflow-hidden">
      ...
      <div className="block md:hidden w-full max-w-[390px] mx-auto relative z-20">
        <div className="w-full aspect-[390/440] relative bg-white/40 border border-emerald-800/5 rounded-3xl shadow-sm p-4 overflow-hidden">
          ...
          <svg viewBox="0 0 390 440" className="absolute inset-0 w-full h-full pointer-events-none" style={{ overflow: "visible" }}>
            <defs>
              <style>{`
                ...
                @keyframes pulse-ring-mob {
                  0% { transform: scale(0.95); opacity: 0.8; }
                  50% { transform: scale(1.08); opacity: 0.3; }
                  100% { transform: scale(0.95); opacity: 0.8; }
                }
                .pulse-circle-mob {
                  animation: pulse-ring-mob 3s infinite ease-in-out;
            ...
            {/* Farmer (95, 320) -> Traceability (65, 210) */}
            <line x1="95" y1="320" x2="65" y2="210" stroke={isPathActiveMobile(1) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(1) ? "3" : "1.2"} />
            {isPathActiveMobile(1) && <line x1="95" y1="320" x2="65" y2="210" stroke="#10b981" strokeWidth="3" className="flow-path-active-mob" />}

            {/* Traceability (65, 210) -> GIS (95, 140) */}
            <line x1="65" y1="210" x2="95" y2="140" stroke={isPathActiveMobile(2) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(2) ? "3" : "1.2"} />
            {isPathActiveMobile(2) && <line x1="65" y1="210" x2="95" y2="140" stroke="#10b981" strokeWidth="3" className="flow-path-active-mob" />}

            {/* GIS (95, 140) -> AI (195, 75) */}
            <line x1="95" y1="140" x2="195" y2="75" stroke={isPathActiveMobile(3) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(3) ? "3" : "1.2"} />
            {isPathActiveMobile(3) && <line x1="95" y1="140" x2="195" y2="75" stroke="#10b981" strokeWidth="3" className="flow-path-active-mob" />}

            {/* AI (195, 75) -> Marketplace (295, 140) */}
            <line x1="195" y1="75" x2="295" y2="140" stroke={isPathActiveMobile(4) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(4) ? "3" : "1.2"} />
            {isPathActiveMobile(4) && <line x1="195" y1="75" x2="295" y2="140" stroke="#10b981" strokeWidth="3" className="flow-path-active-mob" />}

            {/* Marketplace (295, 140) -> Finance (325, 210) */}
            <line x1="295" y1="140" x2="325" y2="210" stroke={isPathActiveMobile(5) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(5) ? "3" : "1.2"} />
            {isPathActiveMobile(5) && <line x1="295" y1="140" x2="325" y2="210" stroke="#10b981" strokeWidth="3" className="flow-path-active-mob" />}

            {/* Finance (325, 210) -> Carbon (295, 320) */}
            <line x1="325" y1="210" x2="295" y2="320" stroke={isPathActiveMobile(6) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(6) ? "3" : "1.2"} />
            {isPathActiveMobile(6) && <line x1="325" y1="210" x2="295" y2="320" stroke="#10b981" strokeWidth="3" className="flow-path-active-mob" />}

            {/* Return Loop: Carbon (295, 320) -> Farmer (95, 320) */}
            <path d="M 295 320 C 240 365 150 365 95 320" fill="none" stroke={selectedSliceIndex !== null ? "#10b981" : "rgba(0, 77, 38, 0.04)"} strokeWidth={selectedSliceIndex !== null ? "2.5" : "1.2"} strokeDasharray="4 4" className={selectedSliceIndex !== null ? "flow-path-active-mob" : ""} />
            ...
            {SLICES.map((s, i) => {
              ...
              const coords = [
                { x: 95, y: 320 }, // Farmer
                { x: 65, y: 210 }, // Traceability
                { x: 95, y: 140 }, // GIS
                { x: 195, y: 75 }, // AI
                { x: 295, y: 140 }, // Marketplace
                { x: 325, y: 210 }, // Finance
                { x: 295, y: 320 }  // Carbon
              ][i];
          ...
          {/* ── Dominant Data Green Central Hub (Absolute HTML) ── */}
          <div
            style={{ left: "195px", top: "210px" }}
            className="absolute -translate-x-1/2 -translate-y-1/2 w-[104px] h-[104px] rounded-full bg-white border-4 border-[#10b981] flex flex-col items-center justify-center shadow-[0_8px_30px_rgba(16,185,129,0.15)] z-10"
          >
            <div className="absolute inset-0 rounded-full border border-dashed border-[#10b981]/30 animate-spin" style={{ animationDuration: "15s" }} />
            <ShieldCheck className="w-6 h-6 text-[#10b981] mb-0.5 animate-pulse" />
            <span className="text-[9px] font-black tracking-widest text-[#004D26] uppercase">DATA GREEN</span>
          ...
          {[
            { x: 95, y: 320, labelPos: "below" }, // Farmer
            { x: 65, y: 210, labelPos: "below" }, // Traceability
            { x: 95, y: 140, labelPos: "below" }, // GIS
            { x: 195, y: 75, labelPos: "above" }, // AI
            { x: 295, y: 140, labelPos: "below" }, // Marketplace
            { x: 325, y: 210, labelPos: "below" }, // Finance
            { x: 295, y: 320, labelPos: "below" }  // Carbon
          ].map((coords, i) => {
            const s = SLICES[i];
            ...
            return (
              ...
              >
                ...
                <span
                  className={`absolute w-24 text-center text-[9px] font-extrabold uppercase tracking-wider leading-none transition-all duration-300 pointer-events-none ${
                    coords.labelPos === "above" ? "bottom-15" : "top-15"
                  } ${isSel ? "text-[#10b981] scale-105" : "text-[#004D26]"} ${dim ? "opacity-35" : "opacity-100"}`}
                >
                  {s.id === "farmer" ? "Farmer Portal" : s.id === "traceability" ? "Traceability" : s.id === "gis" ? "GIS Mapping" : s.id === "ai" ? "AI Predictions" : s.id === "marketplace" ? "Marketplace" : s.id === "finance" ? "Finance & Wallet" : "Carbon / ESG"}
                </span>
              </div>
            );
          })}
          ...
          >
            ...
            <div className="flex items-start justify-between w-full mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-black tracking-wider text-[#004D26] uppercase leading-tight">
              ...
              <button
                onClick={() => setSelectedSliceIndex(null)}
                className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:text-gray-600 shrink-0"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            {/* Description */}
            <p className="text-xs text-gray-600 font-semibold leading-relaxed mb-5 border-b border-gray-50 pb-4">
              {SLICES[selectedSliceIndex].description}
            </p>

            {/* Capabilities Checklist */}
            <div className="mb-5">
              <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-2.5">Key Capabilities</h4>
            ...
            {/* Structured Inputs/Outputs Workflow (Receives ➔ Processes ➔ Produces ➔ Feeds) */}
            <div className="mb-6">
              <h4 className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-3">Ecosystem Connectivity</h4>
              <div className="grid grid-cols-2 gap-3">
                
                {/* Receives */}
                <div className="bg-emerald-50/20 border border-emerald-800/5 rounded-xl p-3">
                  <span className="text-[8.5px] font-black uppercase text-blue-500 tracking-wider block mb-1.5">Receives (Inputs)</span>
                  <div className="flex flex-col gap-1">
                    {SLICES[selectedSliceIndex].receives.map((item, idx) => (
                      <div key={idx} className="flex items-center gap-1.5 text-[9.5px] font-bold text-gray-700 uppercase">
                ...
                {/* Processes */}
                <div className="bg-emerald-50/20 border border-emerald-800/5 rounded-xl p-3">
                  <span className="text-[8.5px] font-black uppercase text-amber-500 tracking-wider block mb-1.5">Processes</span>
                  <div className="flex flex-col gap-1">
                ...
                {/* Produces */}
                <div className="bg-emerald-50/20 border border-emerald-800/5 rounded-xl p-3">
                  <span className="text-[8.5px] font-black uppercase text-[#10b981] tracking-wider block mb-1.5">Produces (Outputs)</span>
                  <div className="flex flex-col gap-1">
                ...
                {/* Feeds */}
                <div className="bg-emerald-50/20 border border-emerald-800/5 rounded-xl p-3">
                  <span className="text-[8.5px] font-black uppercase text-purple-500 tracking-wider block mb-1.5">Feeds (Downstream)</span>
                  <div className="flex flex-col gap-1">
            ...
            {/* CTA */}
            <button className="w-full bg-[#004D26] hover:bg-[#00381b] active:scale-[0.99] text-white font-extrabold text-xs py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 mt-4 transition-all uppercase tracking-wider">
      ...
      <div className="hidden md:block xl:hidden w-full max-w-[720px] mx-auto relative z-20">
        <div className="w-full aspect-[720/430] relative bg-white/40 border border-emerald-800/5 rounded-3xl shadow-sm p-4 overflow-hidden">
          ...
          <svg viewBox="0 0 720 430" className="absolute inset-0 w-full h-full pointer-events-none" style={{ overflow: "visible" }}>
            ...
            {/* Connecting Pathways between nodes on tablet */}
            {/* Farmer (214, 325) -> Traceability (164, 220) */}
            <line x1="214" y1="325" x2="164" y2="220" stroke={isPathActiveMobile(1) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(1) ? "3" : "1.2"} />
            {isPathActiveMobile(1) && <line x1="214" y1="325" x2="164" y2="220" stroke="#10b981" strokeWidth="3" className="flow-path-active-tab" />}

            {/* Traceability (164, 220) -> GIS (214, 115) */}
            <line x1="164" y1="220" x2="214" y2="115" stroke={isPathActiveMobile(2) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(2) ? "3" : "1.2"} />
            {isPathActiveMobile(2) && <line x1="164" y1="220" x2="214" y2="115" stroke="#10b981" strokeWidth="3" className="flow-path-active-tab" />}

            {/* GIS (214, 115) -> AI (360, 60) */}
            <line x1="214" y1="115" x2="360" y2="60" stroke={isPathActiveMobile(3) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(3) ? "3" : "1.2"} />
            {isPathActiveMobile(3) && <line x1="214" y1="115" x2="360" y2="60" stroke="#10b981" strokeWidth="3" className="flow-path-active-tab" />}

            {/* AI (360, 60) -> Marketplace (506, 115) */}
            <line x1="360" y1="60" x2="506" y2="115" stroke={isPathActiveMobile(4) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(4) ? "3" : "1.2"} />
            {isPathActiveMobile(4) && <line x1="360" y1="60" x2="506" y2="115" stroke="#10b981" strokeWidth="3" className="flow-path-active-tab" />}

            {/* Marketplace (506, 115) -> Finance (556, 220) */}
            <line x1="506" y1="115" x2="556" y2="220" stroke={isPathActiveMobile(5) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(5) ? "3" : "1.2"} />
            {isPathActiveMobile(5) && <line x1="506" y1="115" x2="556" y2="220" stroke="#10b981" strokeWidth="3" className="flow-path-active-tab" />}

            {/* Finance (556, 220) -> Carbon (506, 325) */}
            <line x1="556" y1="220" x2="506" y2="325" stroke={isPathActiveMobile(6) ? "#10b981" : "rgba(0, 77, 38, 0.08)"} strokeWidth={isPathActiveMobile(6) ? "3" : "1.2"} />
            {isPathActiveMobile(6) && <line x1="556" y1="220" x2="506" y2="325" stroke="#10b981" strokeWidth="3" className="flow-path-active-tab" />}

            {/* Return loop for tablet */}
            <path d="M 506 325 C 430 380 290 380 214 325" fill="none" stroke={selectedSliceIndex !== null ? "#10b981" : "rgba(0, 77, 38, 0.04)"} strokeWidth={selectedSliceIndex !== null ? "2.5" : "1.2"} strokeDasharray="5 5" className={selectedSliceIndex !== null ? "flow-path-active-tab" : ""} />
            ...
            {SLICES.map((s, i) => {
              ...
              const coords = [
                { x: 214, y: 325 }, // Farmer
                { x: 164, y: 220 }, // Traceability
                { x: 214, y: 115 }, // GIS
                { x: 360, y: 60 },  // AI
                { x: 506, y: 115 }, // Marketplace
                { x: 556, y: 220 }, // Finance
                { x: 506, y: 325 }  // Carbon
              ][i];
          ...
          <div
            ...
            className="absolute -translate-x-1/2 -translate-y-1/2 w-[124px] h-[124px] rounded-full bg-white border-4 border-[#10b981] flex flex-col items-center justify-center shadow-[0_8px_30px_rgba(16,185,129,0.15)] z-10"
          >
            <div className="absolute inset-0 rounded-full border border-dashed border-[#10b981]/30 animate-spin" style={{ animationDuration: "20s" }} />
          ...
          {[
            { x: 214, y: 325, labelPos: "below" }, // Farmer
            { x: 164, y: 220, labelPos: "below" }, // Traceability
            { x: 214, y: 115, labelPos: "below" }, // GIS
            { x: 360, y: 60, labelPos: "above" },  // AI
            { x: 506, y: 115, labelPos: "below" }, // Marketplace
            { x: 556, y: 220, labelPos: "below" }, // Finance
            { x: 506, y: 325, labelPos: "below" }  // Carbon
          ].map((coords, i) => {
            const s = SLICES[i];
            const isSel = selectedSliceIndex === i;
            const dim = selectedSliceIndex !== null && !isSel;
            ...
            return (
              ...
              >
                ...
                <span
                  className={`absolute w-28 text-center text-[10px] font-extrabold uppercase tracking-wider leading-none transition-all duration-300 pointer-events-none ${
        ...
        <div className="mt-6 min-h-[120px] transition-all duration-300">
          {selectedSliceIndex !== null ? (
            <div className="bg-white border border-emerald-800/10 rounded-3xl p-6 shadow-sm transition-all duration-300">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-4 mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-[#004D26] uppercase tracking-wider leading-none">
                      {SLICES[selectedSliceIndex].name}
                    </h3>
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                {/* Right side connectivity blocks */}
                <div className="border-l border-gray-100 pl-6 flex flex-col justify-between">
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-50 rounded-lg p-2 text-left">
                      <span className="text-[8px] font-black uppercase text-blue-500 block mb-0.5">Receives</span>
                      <span className="text-[9px] font-bold text-gray-600 uppercase block truncate">{SLICES[selectedSliceIndex].receives[0]}</span>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-2 text-left">
                      <span className="text-[8px] font-black uppercase text-purple-500 block mb-0.5">Feeds</span>
                      <span className="text-[9px] font-bold text-gray-600 uppercase block truncate">{SLICES[selectedSliceIndex].feeds[0]}</span>
                    </div>
                  </div>
                  <button className="w-full bg-[#004D26] hover:bg-[#00381b] text-white font-extrabold text-xs py-2.5 px-3 rounded-lg flex items-center justify-center gap-2 transition-all uppercase tracking-wider mt-3">
              ...
              return (
                <foreignObject key={`desk-${s.id}`} x={fx} y={fy} width={W} height={H} style={{ overflow: "visible" }}>
                  <div
                    ...
                    className={`w-full h-full rounded-2xl p-5 flex flex-col items-start justify-between text-left transition-all duration-300 border bg-white cursor-pointer ${
                      isH
          ...
          <div className="bg-emerald-50/40 border border-emerald-100/50 rounded-2xl px-6 py-3.5 text-center shadow-sm w-full transition-all duration-300">
            {hoveredSlice !== null ? (
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-gray-500 font-semibold">Hover any module card above to trace the chronological data journey from farm onboarding to carbon finance outcomes.</p>
              </div>
            )}
          </div>
        </div>
