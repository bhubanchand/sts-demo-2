      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8">
         <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
               ...
               <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-[#0B3D2E] mb-6">Plays well with your existing stack.</h2>
            ...
            <div className="lg:w-1/2 w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
               <div className="bg-white rounded-3xl p-5 sm:p-8 border border-gray-100 shadow-sm flex flex-col items-center justify-center text-center gap-4 hover:-translate-y-1 transition-transform cursor-pointer">
